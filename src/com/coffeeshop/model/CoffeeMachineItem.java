...
public class CoffeeMachineItem implements MenuItem{
    private int id;
    private String name;
    ...
    public CoffeeMachineItem(int id, String name, String category,double price,String description, String icon, String status) {
        this.id = id;
        this.name = name;
    ...
    public CoffeeMachineItem(CoffeeMachineItem other) {
        this.id = other.getId();
    ...
    public CoffeeMachineItem clone() {
        return new CoffeeMachineItem(this);
    }
}
