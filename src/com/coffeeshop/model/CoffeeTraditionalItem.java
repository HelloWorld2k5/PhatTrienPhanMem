...
public class CoffeeTraditionalItem implements MenuItem{
    private int id;
    private String name;
    ...
    public CoffeeTraditionalItem(int id, String name, String category,double price,String description, String icon, String status) {
        this.id = id;
        this.name = name;
    ...
    public CoffeeTraditionalItem clone() {
        return new CoffeeTraditionalItem(this);
    }
}
